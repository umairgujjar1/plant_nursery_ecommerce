...
<body>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            {{-- <li class="nav-item">
                <a class="nav-link collapsed" href="{{ URL::to('/categories') }}">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ URL::to('/contact-us') }}">
                    <i class="bi bi-envelope"></i>
                    <span>Contact</span>
                </a>
            </li><!-- End Contact Page Nav -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ URL::to('/subscriber') }}">
                    <i class="bi bi-box-arrow-in-right"></i>
                    <span>Subscriber</span>
                </a>
            </li><!-- End Login Page Nav -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ URL::to('/user') }}">
                    <i class="bi bi-box-arrow-in-right"></i>
                    <span>User</span>
                </a>
            </li><!-- End Login Page Nav -->
